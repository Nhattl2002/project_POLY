...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="https://cdn.printgo.vn/uploads/media/774255/logo-giay-1_1586510617.jpg" alt="" width="80" height="50" class="d-inline-block align-text-top"> 
    </a>
  </div>
</nav>
	<!-- Nav -->
				...
				<div class="row">
					...
					<div class="col-5 p-0 m-0">
						<div class="fw-bold fs-4 text-center"
							style="background-color: #EDDF40; color: #FCFCFC">JK SHOP</div>
						<form:form method="POST"
							...
							<div>
								<button type="submit" class="fs-5 btn btn-info btn-block mb-4"
									style="background-color: #50C7AB; color: #FCFCFC">Sign
									in</button>
							</div>
